...
if __name__ == '__main__':
  ...
  for encoding in encoding_variants:
    for domain in typed_domains:
      ...
      f.write("CUR_DATE=`date +%Y%m%d%T`\n")
      f.write('mkdir “$CUR_DATE”\n\n')
      ...
      if(encoding == 'UG'):
        f.write("time python3 main.py --dir " + typed_domain_path + domain + default_file_names + " --run_benchmarks 1 --time_limit 5000 > “$CUR_DATE”/out_UG_" + domain_name + "_$SLURM_JOB_ID\n")
        command = 'sbatch ' + "run_UG_"+ domain_name + ".sh"
      elif(encoding == 'UG_po'):
        f.write("time python3 main.py --dir " + typed_domain_path + domain + default_file_names + " --parameters_overlap 1 --run_benchmarks 1 --time_limit 5000 > “$CUR_DATE”/out_UG_po_" + domain_name + "_$SLURM_JOB_ID\n")
        command = 'sbatch ' + "run_UG_po_"+ domain_name + ".sh"
      elif(encoding == 'UG_po_pre'):
        f.write("time python3 main.py --dir " + typed_domain_path + domain + default_file_names + " --preprocessing 1 --run 1 --parameters_overlap 1 --run_benchmarks 1 --time_limit 5000 > “$CUR_DATE”/out_UG_po_pre_" + domain_name + "_$SLURM_JOB_ID\n")
        command = 'sbatch ' + "run_UG_po_pre_"+ domain_name + ".sh"
      elif(encoding == 'SAT'):
        f.write("time python3 main.py --dir " + typed_domain_path + domain + default_file_names + " --run_benchmarks 1 -e SAT --solver_type 5 --time_limit 5000 > “$CUR_DATE”/out_SAT_" + domain_name + "$SLURM_JOB_ID\n")
